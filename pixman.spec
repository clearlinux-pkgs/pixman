...
Version  : 0.43.2
Release  : 58
URL      : https://cairographics.org/releases/pixman-0.43.2.tar.gz
Source0  : https://cairographics.org/releases/pixman-0.43.2.tar.gz
...
%prep
%setup -q -n pixman-0.43.2
cd %{_builddir}/pixman-0.43.2
pushd ..
cp -a pixman-0.43.2 build32
popd
pushd ..
cp -a pixman-0.43.2 buildavx2
popd
pushd ..
cp -a pixman-0.43.2 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706547315
...
popd
rm -rf builddiravx2
CFLAGS="$CFLAGS_USE -march=x86-64-v3 -Wl,-z,x86-64-v3 " CXXFLAGS="$CXXFLAGS_USE -march=x86-64-v3 -Wl,-z,x86-64-v3 " LDFLAGS="$LDFLAGS_USE -Wl,-z,x86-64-v3 " meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dmmx=disabled \
-Dsse2=enabled \
-Dssse3=enabled \
-Dgtk=disabled  builddiravx2
ninja -v -C builddiravx2
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpixman-1.so.0.43.2
/V4/usr/lib64/libpixman-1.so.0.43.2
/usr/lib64/libpixman-1.so.0
/usr/lib64/libpixman-1.so.0.43.2
