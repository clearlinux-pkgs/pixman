...
Version  : 0.43.0
Release  : 57
URL      : https://cairographics.org/releases/pixman-0.43.0.tar.gz
Source0  : https://cairographics.org/releases/pixman-0.43.0.tar.gz
...
%prep
%setup -q -n pixman-0.43.0
cd %{_builddir}/pixman-0.43.0
pushd ..
cp -a pixman-0.43.0 build32
popd
pushd ..
cp -a pixman-0.43.0 buildavx2
popd
pushd ..
cp -a pixman-0.43.0 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704388091
...
ninja -v -C builddir
CFLAGS="$CFLAGS_GENERATE -m64 -march=x86-64-v3 -O3 -Wl,-z,x86-64-v3" CXXFLAGS="$CXXFLAGS_GENERATE -m64 -march=x86-64-v3 -Wl,-z,x86-64-v3 " LDFLAGS="$LDFLAGS_GENERATE -m64 -march=x86-64-v3" meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dmmx=disabled \
-Dsse2=enabled \
-Dssse3=enabled \
...
popd
rm -rf builddiravx2
CFLAGS="$CFLAGS_USE -m64 -march=x86-64-v3 -Wl,-z,x86-64-v3 -O3" CXXFLAGS="$CXXFLAGS_USE -m64 -march=x86-64-v3 -Wl,-z,x86-64-v3 " LDFLAGS="$LDFLAGS_USE -m64 -march=x86-64-v3" meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dmmx=disabled \
-Dsse2=enabled \
-Dssse3=enabled \
-Dgtk=disabled  builddiravx2
ninja -v -C builddiravx2
CFLAGS="$CFLAGS_GENERATE -m64 -march=x86-64-v4 -Wl,-z,x86-64-v4 -O3" CXXFLAGS="$CXXFLAGS_GENERATE -m64 -march=x86-64-v4 -Wl,-z,x86-64-v4  -mprefer-vector-width=512" LDFLAGS="$LDFLAGS_GENERATE -m64 -march=x86-64-v4" meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dmmx=disabled \
-Dsse2=enabled \
-Dssse3=enabled \
...
CFLAGS="$CFLAGS_USE -m64 -march=x86-64-v4 -Wl,-z,x86-64-v4 -O3 -mprefer-vector-width=512" CXXFLAGS="$CXXFLAGS_USE -m64 -march=x86-64-v4 -Wl,-z,x86-64-v4  -mprefer-vector-width=512" LDFLAGS="$LDFLAGS_USE -m64 -march=x86-64-v4" meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dmmx=disabled \
-Dsse2=enabled \
-Dssse3=enabled \
-Dgtk=disabled  builddiravx512
ninja -v -C builddiravx512
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpixman-1.so.0.43.0
/V4/usr/lib64/libpixman-1.so.0.43.0
/usr/lib64/libpixman-1.so.0
/usr/lib64/libpixman-1.so.0.43.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libpixman-1.so.0
/usr/lib32/libpixman-1.so.0.43.0
