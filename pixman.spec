...
Source0  : https://cairographics.org/releases/pixman-0.46.2.tar.gz
...
%prep
%setup -q -n pixman-0.46.2
cd %{_builddir}/pixman-0.46.2
pushd ..
cp -a pixman-0.46.2 build32
popd
pushd ..
cp -a pixman-0.46.2 buildavx2
popd
pushd ..
cp -a pixman-0.46.2 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749675941
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpixman-1.so.0.46.2
/V4/usr/lib64/libpixman-1.so.0.46.2
/usr/lib64/libpixman-1.so.0
/usr/lib64/libpixman-1.so.0.46.2
