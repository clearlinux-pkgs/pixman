...
Source0  : https://cairographics.org/releases/pixman-0.46.0.tar.gz
...
%prep
%setup -q -n pixman-0.46.0
cd %{_builddir}/pixman-0.46.0
pushd ..
cp -a pixman-0.46.0 build32
popd
pushd ..
cp -a pixman-0.46.0 buildavx2
popd
pushd ..
cp -a pixman-0.46.0 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746205711
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpixman-1.so.0.46.0
/V4/usr/lib64/libpixman-1.so.0.46.0
/usr/lib64/libpixman-1.so.0
/usr/lib64/libpixman-1.so.0.46.0
